...
const extendedBook={...book, editorial:'Clasicos Roxil'}
console.log(extendedBook)

// Operador condicional y template strings
const pagesRange=numPages>500?'More than 500': 'Less than 500 pages'
...
console.log(sumReview(getBook(3)))
...
const booksAfterUpdate2= booksAfterDelete.map(book => books.id == 1? book: {...book,  title:newName})
